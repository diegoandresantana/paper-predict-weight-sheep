...
class MLSklean():
     ...
     def __init__(self,QTD_FOLDS):
            ...
            pass
     def run(self, x_train, y_train, x_test,y_test,fold_name,fold):
...
if __name__ == "__main__":
    ...
    #sns.distplot(data['ProdSoja2017'] , fit=norm);

    # Get the fitted parameters used by the function
    #(mu, sigma) = norm.fit(data['ProdSoja2017'])
    #print( '\n mu = {:.2f} and sigma = {:.2f}\n'.format(mu, sigma))
    ...
    #fig = plt.figure()
    #res = stats.probplot(data['ProdSoja2017'], plot=plt)
    #plt.show() 
    #plt.savefig('_distribuition.png')
    #plt.close()
    cols=['Eucl_A_C','Eucl_A_D','Eucl_B_C','Eucl_B_D','Eucl_C_D','EquivalentDiameter','AspectRatio','Solidity', 'K_0_19','K_20_39','K_80_99', 'K_100_119', 'K_120_139', 'K_160_180', 'Hu_0' , 'Hu_1', 'Hu_2' ,'Hu_3','Hu_4','Hu_5','Hu_6', 'Weight']
 cols=['Eucl_A_C','Eucl_A_D','Eucl_B_C','Eucl_B_D','Eucl_C_D','EquivalentDiameter','AspectRatio','Solidity','Area','Perimeter','K_0_19','K_20_39','K_80_99', 'K_100_119', 'K_120_139', 'K_160_180', 'Hu_0' , 'Hu_1', 'Hu_2' ,'Hu_3','Hu_4','Hu_5','Hu_6','Major_axis','Weight']


    
    kfold = KFold(QTD_FOLDS)
    x=data.drop(cols, axis=1).copy()
    y=data['Weight'].copy()
    ...
    for train, test in kfold.split(data):
       ...
       ml.run(x_train, y_train,x_test, y_test,"Fold_"+str(i),i)
       i=i+1   
